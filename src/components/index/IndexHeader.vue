<template>
	<div class="navbar">
		<div class="title" :style='{"margin":"0","top":"0","textAlign":"center","left":"60px","background":"none","display":"block","width":"auto","position":"absolute","order":"1"}'>
			...
			<span class="title-name" :style='{"padding":"0 0 0 12px","lineHeight":"75px","fontSize":"18px","color":"#2681b8","fontWeight":"500"}'>{{this.$project.projectName}}</span>
		</div>
		<!--
		...
		<el-dropdown @command="handleCommand" trigger="click" :style='{"padding":"0px","fontSize":"inherit","color":"inherit","background":"none","display":"inline-block","order":"10"}'>
		  <div class="el-dropdown-link" :style='{"alignItems":"center","display":"flex"}'>
		    <el-image v-if="user" :style='{"border":"0px solid #727b84","margin":"0 10px","objectFit":"cover","borderRadius":"100%","display":"inline-block","width":"32px","height":"32px","order":"2"}' :src="avatar?this.$base.url + avatar : require('@/assets/img/avator.png')" fit="cover"></el-image>
