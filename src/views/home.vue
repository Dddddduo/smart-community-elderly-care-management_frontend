<template>
<div class="content" :style='{"minHeight":"100vh","padding":"0px 30px 20px","alignItems":"flex-start","flexWrap":"wrap","background":"url() no-repeat center top / cover,#e9ecf3","display":"block","fontSize":"14px","height":"auto"}'>
	<!-- notice -->
	<!-- title -->
	<div class="text" :style='{"margin":"20px auto","color":"#697882","textAlign":"center","display":"block","width":"100%","fontSize":"22px","fontWeight":"500"}'>欢迎使用 {{this.$project.projectName}}</div>
	<!-- statis -->
	<div :style='{"border":"0px solid #bababa","padding":"0","margin":"10px 0 20px","alignItems":"flex-start","color":"#fff","display":"flex","justifyContent":"center","overflow":"hidden","borderRadius":"0px","flexWrap":"wrap","background":"none","width":"100%","fontSize":"14px","order":"0"}'>
		<div :style='{"padding":"20px","margin":"0 2% 12px 0","borderColor":"#e7e8f8","alignItems":"center","textAlign":"center","display":"flex","float":"left","justifyContent":"flex-start","overflow":"hidden","borderRadius":"5px","background":"#3598dc","borderWidth":"0px","flex":"1","width":"18%","position":"relative","borderStyle":"solid"}' v-if="isAuth('yonghu','首页总数')">
			...
			<div :style='{"margin":"0 0 0 20px","alignItems":"flex-end","textAlign":"left","flexDirection":"column","background":"none","display":"flex","width":"calc(100% - 70px)","justifyContent":"center"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"34px","color":"inherit","fontWeight":"500","height":"24px"}'>{{yonghuCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"14px","color":"inherit","height":"24px"}'>用户总数</div>
			</div>
		</div>
		<div :style='{"padding":"20px","margin":"0 2% 12px 0","borderColor":"#e7f8f8","alignItems":"center","textAlign":"center","display":"flex","float":"left","justifyContent":"flex-start","overflow":"hidden","borderRadius":"5px","background":"#e7505a","borderWidth":"0px","flex":"1","width":"18%","position":"relative","borderStyle":"solid"}' v-if="isAuth('hulirenyuan','首页总数')">
			<div :style='{"alignItems":"center","borderRadius":"100%","background":"none","display":"flex","width":"50px","justifyContent":"center","height":"50px"}'>
			...
			<div :style='{"margin":"0 0 0 20px","alignItems":"flex-end","textAlign":"left","flexDirection":"column","display":"flex","width":"calc(100% - 70px)","justifyContent":"center"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"34px","color":"inherit","fontWeight":"500","height":"24px"}'>{{hulirenyuanCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"14px","color":"inherit","height":"24px"}'>护理人员总数</div>
			</div>
		</div>
	</div>
	<!-- statis -->
	...
	<!-- echarts -->
	<!-- 5 -->
	<div class="type5" :style='{"alignContent":"flex-start","padding":"0","borderRadius":"8px","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative","justifyContent":"space-between","height":"auto","order":"3"}'>
		<div id="yonghuChart1" class="echarts1" v-if="isAuth('yonghu','首页统计')"></div>
		<div id="yanglaofuwuChart2" class="echarts2" v-if="isAuth('yanglaofuwu','首页统计')"></div>
		<div id="jiankangzhuangkuangChart1" class="echarts3" v-if="isAuth('jiankangzhuangkuang','首页统计')"></div>
		<div id="jiankangzhuangkuangChart2" class="echarts4" v-if="isAuth('jiankangzhuangkuang','首页统计')"></div>
		<div id="jiankangzhuangkuangChart3" class="echarts5" v-if="isAuth('jiankangzhuangkuang','首页统计')"></div>
	</div>
</div>
</template>
<script>
...
export default {
    ...
    yanglaofuwuChat2() {
      this.$nextTick(()=>{
        ...
        var yanglaofuwuChart2 = echarts.init(document.getElementById("yanglaofuwuChart2"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                yanglaofuwuChart2.setOption(option);
				
                  //根据窗口的大小变动图表
                window.onresize = function() {
                    yanglaofuwuChart2.resize();
                };
            }
        });
      })
