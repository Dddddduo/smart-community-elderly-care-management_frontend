		...
		<div :style='{"width":"100%","padding":"10px 10px 0","overflow":"hidden","display":"flex","height":"calc(100vh - 80px)"}'>
			<div :style='{"width":"30%","padding":"0 0px","flexWrap":"wrap","display":"flex"}'>
				<div class="tables">
					...
					<el-table :data="boardDataList" border :stripe="false" :style='{"width":"100%","padding":"0","borderColor":"rgba(0,205,215,.3)","borderStyle":"solid","borderWidth":"1px 0 0 0px","background":"none"}'>
						...
						<el-table-column :resizable="true" :sortable="false" prop="touxiang" label="头像">
							<template slot-scope="scope">
								<div v-if="scope.row.touxiang">
									<img v-if="scope.row.touxiang.substring(0,4)=='http'" :src="scope.row.touxiang.split(',')[0]" width="30" height="30">
									<img v-else :src="$base.url+scope.row.touxiang.split(',')[0]" width="30" height="30">
								</div>
								<div v-else>无图片</div>
							</template>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="shenghuoxiguan" label="生活习惯"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="yiwangbingshi" label="以往病史"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="manxingbing" label="慢性病"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="jiankangzhuangkuang" label="健康状况"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="hulixingming" label="护理姓名"/>
						</el-table-column>
					</el-table>
				</div>
				<div class="echarts1">
					...
					<div :style='{"width":"100%","padding":"0 16px","background":"url() no-repeat center top / 100% 100%","height":"calc(100% - 40px)"}'>
						<div id="jiankangzhuangkuangChart1" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts2">
					...
					<div :style='{"width":"100%","padding":"0 16px","height":"calc(100% - 40px)"}'>
						<div id="jiankangzhuangkuangChart2" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
			<div :style='{"width":"40%","padding":"0 20px","flexWrap":"wrap","display":"flex"}'>
				...
				<div :style='{"padding":"0","margin":"10px auto 20px","color":"#fff","alignItems":"center","display":"flex","justifyContent":"center","alignContent":"center","background":"none","width":"98%","fontSize":"14px","height":"130px","order":"1","zIndex":"9"}'>
					...
					<div :style='{"margin":"0 2% 0 0","alignItems":"center","background":"url(http://codegen.caihongy.cn/20231229/f20f081654fc411e841842291850c3d2.png) no-repeat center top / 100% 100%","flexDirection":"column","display":"flex","width":"18%","justifyContent":"center","height":"100%"}'>
						...
						<div :style='{"padding":"0 0px","alignItems":"center","flexDirection":"column-reverse","display":"flex"}'>
							<div :style='{"lineHeight":"32px","fontSize":"inherit","color":"inherit","height":"32px"}'>用户总数</div>
							<div :style='{"lineHeight":"32px","fontSize":"26px","color":"#fff","fontWeight":"bold","height":"32px"}'>{{yonghuCount}}</div>
						</div>
					</div>
					...
					<div :style='{"margin":"0 2% 0 0","alignItems":"center","background":"url(http://codegen.caihongy.cn/20231229/f20f081654fc411e841842291850c3d2.png) no-repeat center top / 100% 100%","display":"flex","width":"18%","justifyContent":"center","height":"100%"}'>
						...
						<div :style='{"padding":"0 0px","alignItems":"center","flexDirection":"column-reverse","display":"flex"}'>
							<div :style='{"lineHeight":"32px","fontSize":"inherit","color":"inherit","height":"32px"}'>护理人员总数</div>
							<div :style='{"lineHeight":"32px","fontSize":"26px","color":"#fff","fontWeight":"bold","height":"32px"}'>{{hulirenyuanCount}}</div>
						</div>
					</div>
				</div>
				<div :style='{"margin":"0 0 20px","color":"#fff","alignItems":"center","background":"url() no-repeat right bottom","display":"flex","width":"100%","justifyContent":"center","height":"calc(64% - 180px)","order":"2"}'>
					<div id="yanglaofuwuChart1" style="width:100%;height:100%;"></div>
				</div>
				<div class="echarts5">
					<div :style='{"width":"100%","padding":"0 16px","textAlign":"center","background":"url(http://codegen.caihongy.cn/20240104/3d41b9dbc0284d3cbdd0e716fe2d3ed9.png) no-repeat left bottom / 100% auto","height":"40px"}'>
						<div :style='{"color":"#5ed8e8","fontSize":"14px","lineHeight":"40px"}'>
							服务统计
						</div>
					</div>
					<div :style='{"width":"100%","padding":"0 16px","height":"calc(100% - 40px)"}'>
						<div id="yanglaofuwuChart5" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
			<div :style='{"width":"30%","padding":"0 0px","flexWrap":"wrap","display":"flex"}'>
				<div v-if="systemIntroductionDetail" :style='{"padding":"0","margin":"0 0 20px","flexWrap":"wrap","background":"none","display":"flex","width":"100%","height":"calc(32% - 20px)"}'>
					<el-carousel :style='{"width":"50%","margin":"0 auto"}' trigger="click" indicator-position="inside" arrow="always" type="default" direction="horizontal" height="100%" :autoplay="false" :interval="3000" :loop="true">
					...
					<div :style='{"margin":"0 0 0 20px","color":"#ccc","flex":1,"lineHeight":"1.5","fontSize":"14px","overflow-y":"scroll","textIndent":"2em","height":"100%"}' v-html="systemIntroductionDetail.content"></div>
				</div>
				<div class="echarts4">
					<div :style='{"width":"100%","padding":"0 16px","margin":"0 0 0px","textAlign":"center","background":"url(http://codegen.caihongy.cn/20240104/3d41b9dbc0284d3cbdd0e716fe2d3ed9.png) no-repeat left bottom / 100% auto","height":"40px"}'>
						<div :style='{"color":"#5ed8e8","fontSize":"14px","lineHeight":"40px"}'>
					...
					<div :style='{"width":"100%","padding":"0 16px","height":"calc(100% - 40px)"}'>
						<div id="yonghuChart4" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts3">
					<div :style='{"width":"100%","padding":"0 16px","margin":"0 0 0px","textAlign":"center","background":"url(http://codegen.caihongy.cn/20240104/3d41b9dbc0284d3cbdd0e716fe2d3ed9.png) no-repeat left bottom / 100% auto","height":"40px"}'>
					...
					<div :style='{"width":"100%","padding":"0 16px","height":"calc(100% - 40px)"}'>
						<div id="jiankangzhuangkuangChart3" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
		</div>
  ...
  created() {
    this.$nextTick(()=>{
		...
		setTimeout(()=>{
			this.getyonghuCount();
			this.yonghuChat4();
			this.yanglaofuwuChat5();
			this.yanglaofuwuChat1();
			this.gethulirenyuanCount();
			this.jiankangzhuangkuangChat1();
			this.jiankangzhuangkuangChat2();
			this.jiankangzhuangkuangChat3();
		},500)
	})
  },
  methods:{
...
//统计接口1
    yonghuChat4() {
      this.$nextTick(()=>{
        ...
        var yonghuChart4 = echarts.init(document.getElementById("yonghuChart4"),'macarons');
        this.$http({
            url: "yonghu/group/shequ",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
...
//统计接口2
    yanglaofuwuChat5() {
      this.$nextTick(()=>{
        ...
        var yanglaofuwuChart5 = echarts.init(document.getElementById("yanglaofuwuChart5"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                yanglaofuwuChart5.setOption(option);
				

                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    yanglaofuwuChart5.resize();
                },false);
            }
        });
      })
    ...
    yanglaofuwuChat1() {
		this.$nextTick(()=>{
			...
			var yanglaofuwuChart1 = echarts.init(document.getElementById("yanglaofuwuChart1"),'macarons');
			...
			this.$http({
				...
				if (data && data.code === 0) {
					...
					yanglaofuwuChart1.setOption(option);
					//根据窗口的大小变动图表
					window.addEventListener('resize', () => {
						yanglaofuwuChart1.resize();
					},false);
				}
			})
		})
    ...
    gethulirenyuanCount() {
        this.$http({
            url: `hulirenyuan/count`,
            method: "get"
        }).then(({
            data
        }) => {
            if (data && data.code == 0) {
                this.hulirenyuanCount = data.data
            }
        })
    },
...
//统计接口1
    jiankangzhuangkuangChat1() {
      this.$nextTick(()=>{

        var jiankangzhuangkuangChart1 = echarts.init(document.getElementById("jiankangzhuangkuangChart1"),'macarons');
        this.$http({
            url: `jiankangzhuangkuang/value/xingming/xueya`,
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                // 使用刚指定的配置项和数据显示图表。
                jiankangzhuangkuangChart1.setOption(option);
				
				this.myChartInterval(1, option.xAxis.data, option.series[0].data, jiankangzhuangkuangChart1)

                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    jiankangzhuangkuangChart1.resize();
                },false);
            }
        });
      })
...
//统计接口2
    jiankangzhuangkuangChat2() {
      this.$nextTick(()=>{

        var jiankangzhuangkuangChart2 = echarts.init(document.getElementById("jiankangzhuangkuangChart2"),'macarons');
        this.$http({
            url: `jiankangzhuangkuang/value/xingming/xuetang`,
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                var option = {};
				let titleObj = this.bar2?this.bar2.title:this.bar.title
				titleObj.text = '血糖情况'
				
				const legendObj = this.bar2?this.bar2.legend:this.bar.legend
				
				let xAxisObj = this.bar2?this.bar2.xAxis:this.bar.xAxis
				xAxisObj.type = 'value'
                
				
				let yAxisObj = this.bar2?this.bar2.yAxis:this.bar.yAxis
				...
				seriesObj = Object.assign(seriesObj , this.bar2?this.bar2.series:this.bar.series)
                ...
                option = {
					backgroundColor: this.bar2?this.bar2.backgroundColor:this.bar.backgroundColor,
					color: this.bar2?this.bar2.color:this.bar.color,
                    title: titleObj,
					legend: legendObj,
                    tooltip: tooltipObj,
					grid: gridObj,
                ...
                // 使用刚指定的配置项和数据显示图表。
                jiankangzhuangkuangChart2.setOption(option);
				
				this.myChartInterval(2, option.yAxis.data, option.series[0].data, jiankangzhuangkuangChart2)

                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    jiankangzhuangkuangChart2.resize();
                },false);
            }
        });
      })
...
//统计接口3
    jiankangzhuangkuangChat3() {
      this.$nextTick(()=>{

        var jiankangzhuangkuangChart3 = echarts.init(document.getElementById("jiankangzhuangkuangChart3"),'macarons');
        this.$http({
            url: `jiankangzhuangkuang/value/xingming/xinlv`,
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                var option = {};
				let titleObj = this.line3?this.line3.title:this.line.title
				titleObj.text = '心率情况'
				
				const legendObj = this.line3?this.line3.legend:this.line.legend
				...
				let yAxisObj = this.line3?this.line3.yAxis:this.line.yAxis
				yAxisObj.type = 'value'
				...
				seriesObj = Object.assign(seriesObj , this.line3?this.line3.series:this.line.series)
                ...
                option = {
					backgroundColor: this.line3?this.line3.backgroundColor:this.line.backgroundColor,
					color: this.line3?this.line3.color:this.line.color,
                    title: titleObj,
					legend: legendObj,
                    tooltip: tooltipObj,
					grid: gridObj,
                ...
                // 使用刚指定的配置项和数据显示图表。
                jiankangzhuangkuangChart3.setOption(option);
				

                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    jiankangzhuangkuangChart3.resize();
                },false);
            }
        });
      })
